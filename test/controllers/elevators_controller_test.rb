...
class ElevatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create elevator" do
    assert_difference('Elevator.count') do
      post elevators_url, params: { elevator: { columnID: @elevator.columnID, commissioningDate: @elevator.commissioningDate, information: @elevator.information, inspectionCertificate: @elevator.inspectionCertificate, lastInspection: @elevator.lastInspection, model: @elevator.model, notes: @elevator.notes, serialNumber: @elevator.serialNumber, status: @elevator.status, type: @elevator.type } }
    end
  ...
  test "should update elevator" do
    patch elevator_url(@elevator), params: { elevator: { columnID: @elevator.columnID, commissioningDate: @elevator.commissioningDate, information: @elevator.information, inspectionCertificate: @elevator.inspectionCertificate, lastInspection: @elevator.lastInspection, model: @elevator.model, notes: @elevator.notes, serialNumber: @elevator.serialNumber, status: @elevator.status, type: @elevator.type } }
